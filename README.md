...
1. What are the main differences between a stateful and a functional component?
   A functional component is a JS function, while a stateful component is a class that holds state

2. When does a componentWillMount function be called? What about a componentWillUpdate?
   ComponentWillMount gets called after initial dom render, when the application first mounts, while componentWillUpdate gets called any time theres a chasnge in state

3. Define stateful logic.
   Stateful logic deals with component state, and handles state manipulation.

4. What are the three step of creating a successful test? What is done in each phase?
   Arrange: set up by rendering the component that will be tested
   Act: simulate a user's action
